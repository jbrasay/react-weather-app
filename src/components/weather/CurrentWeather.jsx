...
export default function CurrentWeather() {
    ...
    return (
        <div className="flex flex-row xs:flex-wrap md:flex-nowrap w-full h-fit justify-center">
            ...
            <motion.div
                ...
                <div className="flex flex-col w-80 h-40 leading-4 items-center justify-center mt-5 py-32 px-3 text-white bg-opacity-20 bg-green-900 shadow-xl">
                    <h1 className="text-lg">{weather.city}</h1>
                    <h1 className="text-lg">{weather.country}</h1>
                    ...
                    <div className="flex flex-row pb-2 items-end space-x-4">       
                        <h1>H: {currentWeatherData.high_temp} °F</h1>
                        ...
                        <h1>L: {currentWeatherData.low_temp} °F</h1>
                    </div>
                </div>
