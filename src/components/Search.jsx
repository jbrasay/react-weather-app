...
export default function Search({setWeather, setisLoading, setisValid}) {
    ...
    const getWeather = function(loc) {
        ...
        .then(function(res) {
          //console.log("Inside GeoAPI Fetch")
          return res.json()
        })
        .then(function(data) {
          const coordinates = data.results
          //console.log("Geoapify Fetch Data: ")
          ...
          if (coordinates.length === 0) {
            ...
            //console.log(coordinates[0].address_line1)
            //console.log(coordinates[0].country_code.toUpperCase())
            ...
            .then(function(res) {
              //console.log(res)
              //console.log("Inside WeatherBit Fetch")
              return res.json()
        
            })
            .then(function(data) {
              const weatherdata = data
              //console.log("Weatherbit Fetch Data: ")
